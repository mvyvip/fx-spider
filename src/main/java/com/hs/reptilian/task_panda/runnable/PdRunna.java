package com.hs.reptilian.task_panda.runnable;
...
public class PdRunna implements Runnable {
    ...
    public PdRunna(String username, String password, PandaProxyUtil proxyUtil, Integer updateCodeSecond, String goods, String goodsUrl, String vc) {
