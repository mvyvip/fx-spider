...
//                    System.err.println("addr_id获取成功："  + addr_id);
    ...
    private static Map<String, String> getCookies(String username, String password) throws Exception {
		...
		Response execute2 = Jsoup.connect("https://mall.phicomm.com/m/passport-login.html")
			...
			.header("Cookie", "_SID=07adcb978b78bed2c1e1c7e0053616f8; __jsluid=2adb41d06c34d6648068bf65f991cbd4; CACHE_VARY=79e9a2cfad5b086e9017de76915a505c-f97d48f7d515cde89d08f67a90635a23; _VMC_UID=1d65e0b89603f087b8ec24ceaf3acba0; __jsl_clearance=1541410105.259|0|nJThPlZElb63fF4rtUNpcKQasxs%3D")
			.timeout(333333)
			.execute();
