...
public class Jstest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(getck(response.body()));
        ...
        Response execute = Jsoup.connect("https://mall.phicomm.com/passport-login.html")
            ...
            .header("Referer", "https://mall.phicomm.com/passport-login.html")
            .header("Connection", "keep-alive")
            .cookie("__jsluid", "6f4b5a2bae55eb457c63c1479a3cbbcc")
            .cookie("__jsl_clearance", "1541498044.179|0|S7C2DpsUT6J62uXEdY8f1ArnBC4%3D")
            .header("Upgrade-Insecure-Requests", "1")
            .execute();
        System.out.println(execute.body());
        System.out.println(execute.cookies());
        System.out.println(getck(execute.body()));
